...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<JSONObject> {
    ...
    public static final int LOADER_ID = 133;
    ...
    public void onCkickTopRated(View view) {
        setMethodOfSort(true);
        switchSort.setChecked(true);
    }

    public void onCkickPopularity(View view) {
    ...
    public Loader<JSONObject> onCreateLoader(int id, @Nullable Bundle bundle) {
        ...
        jsonLoader.setOnStartLaodingListener(new NetworkUtils.JSONLoader.OnStartLaodingListener() {
            @Override
